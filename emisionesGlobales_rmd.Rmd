...
Estos datos nos indican que se trata de una distribución bastante asimétrica. Es decir, el máximo valor registrado arrastra el promedio de manera exagerada. Con lo cual utilizar la media aritmética se hace poco representativo. Dicho de otro modo, afirmar que "en promedio, cada país del mundo emite 169 mil kilotoneladas de CO2 por año" sería injusto, porque le estaríamos atribuyendo el problema a países que no corresponden y quitándole muchísima precisión al análisis.
...
* Hasta un 50% de los países del mundo emiten hasta alrededor de 11 mil kilotoneladas de CO2.

* El mayor emisor de dióxido de carbono es China, que registra casi 11 millones de kilotoneladas.

Fácilmente podemos observar que es una porción muy pequeña la que concentra la mayor cantidad de emisión de gases. Esto tiende a repetirse con los datos de NO2 y CH4.
